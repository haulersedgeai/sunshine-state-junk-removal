...
Live host audited: `https://www.sunshineremoval.com`
Canonical host: `https://sunshineremoval.com`
Total routes audited: 39
...
- **OG image:** https://sunshine-state-junk-removal.vercel.app/images/Sunshine-About-Us.webp
- **JSON-LD types:** BreadcrumbList, FAQPage, HomeAndConstructionBusiness, ItemList, Service
...
### ✅ `/junk-removal/coral-springs/` (city-service, HTTP 200)
...
### ✅ `/junk-removal/coconut-creek/` (city-service, HTTP 200)
...
### ✅ `/junk-removal/margate/` (city-service, HTTP 200)
...
### ✅ `/junk-removal/parkland/` (city-service, HTTP 200)
...
### ✅ `/junk-removal/tamarac/` (city-service, HTTP 200)
...
### ✅ `/junk-removal/sunrise/` (city-service, HTTP 200)
...
### ✅ `/coral-springs-florida/` (redirect, HTTP 308)
- **<details> FAQ blocks:** 0
- _note: redirects to "/junk-removal/coral-springs/" → destination resolved HTTP 200_

### ✅ `/sunrise/` (redirect, HTTP 308)
- **<details> FAQ blocks:** 0
- _note: redirects to "/junk-removal/sunrise/" → destination resolved HTTP 200_

### ✅ `/tamarac-florida/` (redirect, HTTP 308)
- **<details> FAQ blocks:** 0
- _note: redirects to "/junk-removal/tamarac/" → destination resolved HTTP 200_
...
- `/locations/southwest-ranches/` — second location page (locked address 5011 SW 210 Terrace, Southwest Ranches, FL 33332; map centered on 26.057349, -80.429417; 15-city list; LocalBusiness schema; phone (305) 326-2436 and hours Monday–Saturday 8:00 AM – 6:00 PM added 2026-08-06 from client values)
...
- public/llms.txt: two-location structure (both addresses, both phones, both hours, two city lists, location URLs).
- project-data/locations.json (new) + src/data/locations.ts (new): single source for location data.
