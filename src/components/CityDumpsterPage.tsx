...
import { getSite, getReviews, getServices, prohibitedItemsSurcharge, absoluteUrl, SITE_URL } from '@/data';
...
export function CityDumpsterPage({ content }: { content: CityContent }) {
  ...
  const localFaqs = [
    { q: `How do dump trailer rentals work in ${content.city}?`, a: `We drop the trailer at your driveway, you load it at your pace over the rental window, and we haul it away when you’re done. Pricing is transparent.` },
    ...
    <>
      ...
      <section className="pt-2 pb-0">
        <div className="container-p">
          <PricingHookStrip variant="dumpster" />
        </div>
      </section>
        ...
        <div className="container-p grid gap-10 lg:grid-cols-[1fr_1.2fr] items-center">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-ink-soft">
              ...
              <p>All rentals include labor-free drop-off and clear pricing so you’re not blindsided.</p>
