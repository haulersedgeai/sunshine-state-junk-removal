...
export default function PricingPage() {
  ...
  return (
    <>
      <JsonLd data={graph([junkRemovalOfferSchema(), dumpsterRentalOfferSchema(), faqPageSchema(faqs)])} />
      ...
      <section className="section">
        <div className="container-p grid gap-10 lg:grid-cols-[1.15fr_1fr] items-center">
          <div>
            ...
            <ul className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-navy-800">
              <li className="inline-flex items-center gap-2"><CheckIcon className="h-4 w-4 text-sun-500" /> Labor & disposal included on removals</li>
              <li className="inline-flex items-center gap-2"><CheckIcon className="h-4 w-4 text-sun-500" /> No hidden fees</li>
            </ul>
          </div>
      ...
      <section className="section">
        <div className="container-p">
          <SectionHeading eyebrow="Junk removal" title="Priced by the load, not by the item." intro="You pay for how much space your items fill in our 18-yard dump trailer. Labor and disposal are already baked in." />
          <div className="mt-10">
            <JunkRemovalPricingTable />
          </div>
        </div>
      </section>
        ...
        <div className="container-p grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-navy-900 text-white p-6 shadow-card">
            ...
            <div className="mt-5 flex flex-col gap-2">
              ...
              <Button href="/contact-us/#quote" variant="outline-inverse" size="md" className="w-full">
                Use the quote form →
              </Button>
            </div>
          </div>
